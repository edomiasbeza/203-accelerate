...
function vw_painter_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Shop Page Sidebar', 'vw-painter' ),
		'description'   => __( 'Appears on shop page', 'vw-painter' ),
	...
	register_sidebar( array(
		'name'          => __( 'Single Product Sidebar', 'vw-painter' ),
		'description'   => __( 'Appears on single product page', 'vw-painter' ),
...
function vw_painter_scripts() {
	...
	wp_add_inline_style( 'vw-painter-basic-style',$vw_painter_custom_css );
...
/* admin bar */
function vw_painter_my_filter_head(){
	remove_action('wp_head','_admin_bar_bump_cb');
}
add_action('get_header','vw_painter_my_filter_head');

//define
define('VW_PAINTER_FREE_THEME_DOC',__('https://www.vwthemesdemo.com/docs/free-vw-painter/','vw-painter'));
define('VW_PAINTER_SUPPORT',__('https://wordpress.org/support/theme/vw-painter/','vw-painter'));
define('VW_PAINTER_REVIEW',__('https://wordpress.org/support/theme/vw-painter/reviews/','vw-painter'));
define('VW_PAINTER_BUY_NOW',__('https://www.vwthemes.com/themes/painter-wordpress-theme/','vw-painter'));
define('VW_PAINTER_LIVE_DEMO',__('https://www.vwthemes.net/vw-painter-pro/','vw-painter'));
define('VW_PAINTER_PRO_DOC',__('https://www.vwthemesdemo.com/docs/vw-painter-pro/','vw-painter'));
define('VW_PAINTER_FAQ',__('https://www.vwthemes.com/faqs/','vw-painter'));
define('VW_PAINTER_CHILD_THEME',__('https://developer.wordpress.org/themes/advanced-topics/child-themes/','vw-painter'));
define('VW_PAINTER_CONTACT',__('https://www.vwthemes.com/contact/','vw-painter'));
define('VW_PAINTER_CREDIT',__('https://www.vwthemes.com/themes/free-painter-wordpress-theme/','vw-painter'));

if ( ! function_exists( 'vw_painter_credit' ) ) {
	function vw_painter_credit(){
		echo "<a href=".esc_url(VW_PAINTER_CREDIT).">".esc_html__('Painter WordPress Theme','vw-painter')."</a>";
	}
}
